...
public:
    ...
    bool do_it(std::uint64_t batch_id, std::atomic<int> *completed,
    ...
    af::TaskResult run() override {
        ...
        case State::Apply:
            ...
            Runtime::parallel_shards(
                ops_, af::ParallelMode::AllShards, batch_id_, this,
...
public:
    ...
    bool do_it(std::uint64_t batch_id, std::uint16_t fail_shard, std::atomic<int> *completed,
...
public:
    ...
    bool do_it(std::uint64_t batch_id, std::atomic<int> *completed,
               std::array<std::atomic<int>, 4> *shard_hits, std::atomic<std::uint32_t> *failures) {
        batch_id_ = batch_id;
        completed_ = completed;
        shard_hits_ = shard_hits;
        failures_ = failures;
