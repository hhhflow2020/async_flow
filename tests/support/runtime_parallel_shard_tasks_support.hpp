...
public:
    ...
    bool do_it(af::ParallelMode mode, std::atomic<int> *completed,
...
private:
    ...
    af::TaskResult run() override {
        ...
        case State::Split:
            state_ = State::Finish;
            Runtime::parallel_shards(ops_, af::ParallelMode::NonEmptyOnly, this,
                                     [this](std::uint16_t, std::vector<int> &) {
                                         ran_on_->store(Runtime::current_thread_index(),
