#if !defined(AF_RUNTIME_LIFECYCLE_TEST_SUPPORT_FRAGMENT_INCLUDE)
#error "runtime_lifecycle_backpressure_support_fragment.hpp is a runtime lifecycle test support fragment"
#endif
