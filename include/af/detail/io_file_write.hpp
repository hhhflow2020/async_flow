...
#error "io_file_write.hpp is internal to af/io_file.hpp"
#endif

template <typename TaskT>
[[nodiscard]] IoStatus io_write_some(TaskT &task, typename TaskT::Thread thread,
  ...
  if (!resumed_from_readiness &&
    ...
    if (TaskT::Runtime::io_submit_write_at(thread, fd, data, size,
...
template <typename TaskT>
[[nodiscard]] IoStatus
io_writev_some(TaskT &task, typename TaskT::Thread thread, int fd,
