...
template <typename RuntimeT, typename TraitsT>
Executor<RuntimeT, TraitsT>::~Executor() {
  close_io_backend();
}

template <typename RuntimeT, typename TraitsT>
void Executor<RuntimeT, TraitsT>::start() {
  init_io_backend();
...
template <typename RuntimeT, typename TraitsT>
void Executor<RuntimeT, TraitsT>::join() {
  if (worker_.joinable()) {
    worker_.join();
  }
}
...
template <typename RuntimeT, typename TraitsT>
void Executor<RuntimeT, TraitsT>::notify() noexcept {
