...
#error "io_socket_options.hpp is internal to af/io_socket.hpp"
#endif

template <typename TaskT>
[[nodiscard]] IoStatus
io_setsockopt(TaskT &task, typename TaskT::Thread thread, int fd, int level,
...
template <typename TaskT>
[[nodiscard]] IoStatus io_getsockopt(TaskT &task, typename TaskT::Thread thread,
                                     int fd, int level, int option, void *value,
