...
#error "io_socket_accept.hpp is internal to af/io_socket.hpp"
#endif

template <typename TaskT>
[[nodiscard]] IoStatus
io_accept_some(TaskT &task, typename TaskT::Thread thread, int fd,
  ...
  *accepted_fd = -1;
  ...
  if (!resumed_from_readiness &&
    ...
    if (TaskT::Runtime::io_submit_accept(thread, fd, address, address_size,
