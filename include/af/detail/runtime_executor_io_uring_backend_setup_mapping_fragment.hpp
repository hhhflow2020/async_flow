...
#error "runtime_executor_io_uring_backend_setup_mapping_fragment.hpp is an AsyncRuntime::Executor implementation fragment"
#endif
        ...
        [[nodiscard]] bool map_io_uring_rings(const io_uring_params& params) noexcept {
            ...
            return io_uring_sq_ring_ != MAP_FAILED &&
        ...
        [[nodiscard]] bool register_io_uring_wake_fd() noexcept {
            return detail::sys_io_uring_register(
                       io_uring_fd_,
