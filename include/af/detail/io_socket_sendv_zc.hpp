...
#error "io_socket_sendv_zc.hpp is internal to af/io_socket.hpp"
#endif

#if !defined(_WIN32)
template <typename TaskT>
[[nodiscard]] IoStatus
io_sendv_zc_some(TaskT &task, typename TaskT::Thread thread, int fd,
  ...
  if (!skip_uring && !resumed_from_readiness &&
    ...
    if (TaskT::Runtime::io_submit_sendmsg_zc_iov(
            thread, fd, iov, iov_count, nullptr, 0,
