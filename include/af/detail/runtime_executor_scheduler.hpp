...
template <typename RuntimeT, typename TraitsT>
[[nodiscard]] bool
Executor<RuntimeT, TraitsT>::try_push_local(Task *task) noexcept {
...
template <typename RuntimeT, typename TraitsT>
void Executor<RuntimeT, TraitsT>::advance_ready_word_cursor_after(
...
template <typename RuntimeT, typename TraitsT>
typename Executor<RuntimeT, TraitsT>::Task *
Executor<RuntimeT, TraitsT>::pop_one() noexcept {
