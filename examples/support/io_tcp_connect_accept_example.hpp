...
#include "io_tcp_connect_accept_client_task.hpp"
#include "io_tcp_connect_accept_server_task.hpp"
#include "io_tcp_connect_accept_sockets.hpp"

namespace io_tcp_connect_accept_example {

inline int run_tcp_connect_accept_example() {
    tcp_async::init();
