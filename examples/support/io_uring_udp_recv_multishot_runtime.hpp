...
struct UdpRecvIoThreadTag;

struct UdpRecvRuntimeTraits {
    static constexpr auto threads = af::thread_layout(
        af::thread_group<UdpRecvIoThreadTag, 1, af::preferred_io_thread_kind, "udp-recv">());
...
using UdpRecvThread = udp_recv_async::Thread;

struct UdpRecvThreads {
    static constexpr UdpRecvThread IO_0 =
        udp_recv_async::thread_group<UdpRecvIoThreadTag>().template at<0>();
};
