...
- TCP echo roundtrip benchmark 覆盖 runtime `tcp_server` + loopback client 的 `64/1024/4096` 字节 payload；远端 Linux Release 冒烟约 `8.30us/8.53us/9.50us`，吞吐约 `14.7MiB/s`、`229.1MiB/s`、`822.4MiB/s`。
- TCP multi-connection echo benchmark 覆盖 `16/64` 连接与 `64/1024` 字节 payload 组合；远端 Linux Release 冒烟中 `16x64/16x1024/64x64/64x1024` 约 `54.5us/56.3us/187us/199us`，吞吐约 `35.8MiB/s`、`555.0MiB/s`、`41.8MiB/s`、`628.2MiB/s`。
